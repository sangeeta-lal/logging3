...
public class cloudstack_Training3_IF
{
   ...
   //*/
	...
	{				    
		cloudstack_Training3_IF demo = new cloudstack_Training3_IF();
...
public void ast_prser(String file_name)
	{
		try
		{
			...
			rawContent = cloudstack_Training3_IF.readFileToString(file_name);
